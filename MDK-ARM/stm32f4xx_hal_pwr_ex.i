...
#line 42 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr_ex.c"
...
HAL_StatusTypeDef HAL_PWREx_EnableBkUpReg(void)
{
  ...
  *(volatile uint32_t *) (uint32_t)(0x42000000U + ((((0x40000000U + 0x7000U) - 0x40000000U) + 0x04U) * 32U) + ((9U) * 4U)) = (uint32_t)ENABLE;
...
HAL_StatusTypeDef HAL_PWREx_DisableBkUpReg(void)
{
  ...
  *(volatile uint32_t *) (uint32_t)(0x42000000U + ((((0x40000000U + 0x7000U) - 0x40000000U) + 0x04U) * 32U) + ((9U) * 4U)) = (uint32_t)DISABLE;
...
void HAL_PWREx_EnableFlashPowerDown(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000U + ((((0x40000000U + 0x7000U) - 0x40000000U) + 0x00U) * 32U) + ((9U) * 4U)) = (uint32_t)ENABLE;
}
...
void HAL_PWREx_DisableFlashPowerDown(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000U + ((((0x40000000U + 0x7000U) - 0x40000000U) + 0x00U) * 32U) + ((9U) * 4U)) = (uint32_t)DISABLE;
}
...
#line 367 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr_ex.c"

#line 387 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr_ex.c"

#line 437 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr_ex.c"

#line 623 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr_ex.c"
