...
#line 53 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal.c"
...
#line 79 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal.c"
...
uint32_t HAL_GetHalVersion(void)
{
  return (((0x01U) << 24U) |((0x07U) << 16U) |((0x04U) << 8U ) |((0x00U)));
}
...
void HAL_EnableCompensationCell(void)
{
  *(volatile uint32_t *)(uint32_t)(0x42000000U + (((((0x40000000U + 0x00010000U) + 0x3800U) - 0x40000000U) + 0x20U) * 32U) + ((0U) * 4U)) = (uint32_t)ENABLE;
}
...
void HAL_DisableCompensationCell(void)
{
  *(volatile uint32_t *)(uint32_t)(0x42000000U + (((((0x40000000U + 0x00010000U) + 0x3800U) - 0x40000000U) + 0x20U) * 32U) + ((0U) * 4U)) = (uint32_t)DISABLE;
}
...
#line 588 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal.c"
