...
void MX_GPIO_Init(void)
{
  ...
  LL_AHB1_GRP1_EnableClock((0x1U << (7U)));
  LL_AHB1_GRP1_EnableClock((0x1U << (0U)));
  LL_AHB1_GRP1_EnableClock((0x1U << (3U)));
  LL_AHB1_GRP1_EnableClock((0x1U << (1U)));

   
  LL_GPIO_ResetOutputPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), (0x1U << (0U))|(0x1U << (1U))|(0x1U << (2U))|(0x1U << (3U)) 
                          |(0x1U << (4U))|(0x1U << (5U))|(0x1U << (6U))|(0x1U << (7U)));

   
  LL_GPIO_ResetOutputPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), (0x1U << (3U))|(0x1U << (4U))|(0x1U << (5U))|(0x1U << (6U)) 
                          |(0x1U << (7U)));

   
  GPIO_InitStruct.Pin = (0x1U << (0U))|(0x1U << (1U))|(0x1U << (2U))|(0x1U << (3U)) 
                          |(0x1U << (4U))|(0x1U << (5U))|(0x1U << (6U))|(0x1U << (7U));
  GPIO_InitStruct.Mode = (0x1U << (0U));
  GPIO_InitStruct.Speed = (0x00000000U);
  GPIO_InitStruct.OutputType = (0x00000000U);
  GPIO_InitStruct.Pull = (0x00000000U);
  LL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), &GPIO_InitStruct);

   
  GPIO_InitStruct.Pin = (0x1U << (3U))|(0x1U << (4U))|(0x1U << (5U))|(0x1U << (6U)) 
                          |(0x1U << (7U));
  GPIO_InitStruct.Mode = (0x1U << (0U));
  GPIO_InitStruct.Speed = (0x00000000U);
  GPIO_InitStruct.OutputType = (0x00000000U);
  GPIO_InitStruct.Pull = (0x00000000U);
  LL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), &GPIO_InitStruct);
