...
void MX_USART1_UART_Init(void)
{
  ...
  huart1.Instance = ((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1000U));
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1000U)))
  {
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1000U)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), ((uint16_t)0x0200)|((uint16_t)0x0400));
