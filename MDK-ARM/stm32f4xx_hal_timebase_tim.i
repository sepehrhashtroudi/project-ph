#line 1 "../Src/stm32f4xx_hal_timebase_TIM.c"
...
#line 51 "../Src/stm32f4xx_hal_timebase_TIM.c"
#line 52 "../Src/stm32f4xx_hal_timebase_TIM.c"
...
HAL_StatusTypeDef HAL_InitTick(uint32_t TickPriority)
{
  ...
  do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) |= ((0x1U << (0U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) & ((0x1U << (0U)))); (void)tmpreg; } while(0U);
  ...
  htim1.Instance = ((TIM_TypeDef *) ((0x40000000U + 0x00010000U) + 0x0000U));
