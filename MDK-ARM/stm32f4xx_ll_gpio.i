...
#line 997 "../Drivers/STM32F4xx_HAL_Driver/Inc/stm32f4xx_ll_gpio.h"
...
#line 39 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_gpio.c"
#line 40 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_gpio.c"
...
#line 98 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_gpio.c"
...
ErrorStatus LL_GPIO_DeInit(GPIO_TypeDef *GPIOx)
{
  ...
  if (GPIOx == ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)))
  {
    LL_AHB1_GRP1_ForceReset((0x1U << (0U)));
    LL_AHB1_GRP1_ReleaseReset((0x1U << (0U)));
  }
  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)))
  {
    LL_AHB1_GRP1_ForceReset((0x1U << (1U)));
    LL_AHB1_GRP1_ReleaseReset((0x1U << (1U)));
  }
  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)))
  {
    LL_AHB1_GRP1_ForceReset((0x1U << (2U)));
    LL_AHB1_GRP1_ReleaseReset((0x1U << (2U)));
  }

  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)))
  {
    LL_AHB1_GRP1_ForceReset((0x1U << (3U)));
    LL_AHB1_GRP1_ReleaseReset((0x1U << (3U)));
  }


  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)))
  {
    LL_AHB1_GRP1_ForceReset((0x1U << (4U)));
    LL_AHB1_GRP1_ReleaseReset((0x1U << (4U)));
  }


  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U)))
  {
    LL_AHB1_GRP1_ForceReset((0x1U << (5U)));
    LL_AHB1_GRP1_ReleaseReset((0x1U << (5U)));
  }


  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1800U)))
  {
    LL_AHB1_GRP1_ForceReset((0x1U << (6U)));
    LL_AHB1_GRP1_ReleaseReset((0x1U << (6U)));
  }


  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1C00U)))
  {
    LL_AHB1_GRP1_ForceReset((0x1U << (7U)));
    LL_AHB1_GRP1_ReleaseReset((0x1U << (7U)));
  }


  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x2000U)))
  {
    LL_AHB1_GRP1_ForceReset((0x1U << (8U)));
    LL_AHB1_GRP1_ReleaseReset((0x1U << (8U)));
  }
#line 199 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_gpio.c"
  else
  {
    status = ERROR;
  }
...
ErrorStatus LL_GPIO_Init(GPIO_TypeDef *GPIOx, LL_GPIO_InitTypeDef *GPIO_InitStruct)
{
  ...
  pinpos = (__clz(__rbit(GPIO_InitStruct->Pin)));
  ...
  while (((GPIO_InitStruct->Pin) >> pinpos) != 0x00000000U)
  {
    ...
    if (currentpin)
    {
      ...
      if ((GPIO_InitStruct->Mode == (0x1U << (0U))) || (GPIO_InitStruct->Mode == (0x2U << (0U))))
      {
      ...
      if (GPIO_InitStruct->Mode == (0x2U << (0U)))
      {
         
        ((void)0U);

         
        if ((__clz(__rbit(currentpin))) < 0x00000008U)
        {
...
void LL_GPIO_StructInit(LL_GPIO_InitTypeDef *GPIO_InitStruct)
{
  ...
  GPIO_InitStruct->Pin        = ((0x1U << (0U)) | (0x1U << (1U)) | (0x1U << (2U)) | (0x1U << (3U)) | (0x1U << (4U)) | (0x1U << (5U)) | (0x1U << (6U)) | (0x1U << (7U)) | (0x1U << (8U)) | (0x1U << (9U)) | (0x1U << (10U)) | (0x1U << (11U)) | (0x1U << (12U)) | (0x1U << (13U)) | (0x1U << (14U)) | (0x1U << (15U)));
  GPIO_InitStruct->Mode       = (0x3U << (0U));
