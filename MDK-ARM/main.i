...
TaskHandle_t lcd_demo_handle = 0;
...
int main(void)
{
  ...
  MX_USART1_UART_Init();
	...
	GLCD_Initalize();
	GLCD_ClearScreen();
	xTaskCreate(lcd_demo,"lcd_demo",128,( void * )1,0,&lcd_demo_handle);
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  if (htim->Instance == ((TIM_TypeDef *) ((0x40000000U + 0x00010000U) + 0x0000U))) {
    HAL_IncTick();
  }
