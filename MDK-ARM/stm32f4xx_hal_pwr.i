...
#line 43 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr.c"
...
void HAL_PWR_EnableBkUpAccess(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000U + ((((0x40000000U + 0x7000U) - 0x40000000U) + 0x00U) * 32U) + ((8U) * 4U)) = (uint32_t)ENABLE;
}
...
void HAL_PWR_DisableBkUpAccess(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000U + ((((0x40000000U + 0x7000U) - 0x40000000U) + 0x00U) * 32U) + ((8U) * 4U)) = (uint32_t)DISABLE;
}
...
void HAL_PWR_EnablePVD(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000U + ((((0x40000000U + 0x7000U) - 0x40000000U) + 0x00U) * 32U) + ((4U) * 4U)) = (uint32_t)ENABLE;
}
...
void HAL_PWR_DisablePVD(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000U + ((((0x40000000U + 0x7000U) - 0x40000000U) + 0x00U) * 32U) + ((4U) * 4U)) = (uint32_t)DISABLE;
}
