...
#line 324 "../Drivers/STM32F4xx_HAL_Driver/Inc/stm32f4xx_ll_utils.h"
...
#line 37 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
#line 38 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
#line 39 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
#line 40 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
...
#line 67 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
...
#line 120 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
...
#line 137 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
...
#line 212 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
...
#line 236 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
                                         ...
                                         LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
  ...
  if(UTILS_PLL_IsBusy() == SUCCESS)
  {
    ...
    pllfreq = UTILS_GetPLLOutputFrequency(16000000U, UTILS_PLLInitStruct);
                                         ...
                                         LL_UTILS_PLLInitTypeDef *UTILS_PLLInitStruct, LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
  ...
  if(UTILS_PLL_IsBusy() == SUCCESS)
  {
    ...
    LL_RCC_PLL_ConfigDomain_SYS((0x1U << (22U)), UTILS_PLLInitStruct->PLLM, UTILS_PLLInitStruct->PLLN,
                                UTILS_PLLInitStruct->PLLP);
...
static ErrorStatus UTILS_SetFlashLatency(uint32_t HCLK_Frequency)
{
  ...
  {
    if(LL_PWR_GetRegulVoltageScaling() == ((0x1U << (14U))))
    {
      ...
      if((HCLK_Frequency > 120000000U)&&(latency == 0x00000000U))
      {
        latency = 0x00000004U;
      }


      if((HCLK_Frequency > 90000000U)&&(latency == 0x00000000U))
      {
        latency = 0x00000003U;
      }


      if((HCLK_Frequency > 60000000U)&&(latency == 0x00000000U))
      {
        latency = 0x00000002U;
      }
      else
    ...
    if(LL_PWR_GetRegulVoltageScaling() == 0x00000000U)
    {
#line 549 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
      if((HCLK_Frequency > 12000000U)&&(latency == 0x00000000U))
      {
        latency = 0x00000004U;
      }
...
#line 596 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
...
static uint32_t UTILS_GetPLLOutputFrequency(uint32_t PLL_InputFrequency, LL_UTILS_PLLInitTypeDef *UTILS_PLLInitStruct)
{
  ...
  pllfreq = PLL_InputFrequency / (UTILS_PLLInitStruct->PLLM & ((0x3FU << (0U)) >> (0U)));
  ((void)0U);

   
  pllfreq = pllfreq * (UTILS_PLLInitStruct->PLLN & ((0x1FFU << (6U)) >> (6U)));
  ((void)0U);
...
#line 667 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
...
static ErrorStatus UTILS_EnablePLLAndSwitchSystem(uint32_t SYSCLK_Frequency, LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
  ...
  hclk_frequency = ((SYSCLK_Frequency) >> AHBPrescTable[((UTILS_ClkInitStruct->AHBCLKDivider) & (0xFU << (4U))) >> (4U)]);
